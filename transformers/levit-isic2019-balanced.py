...
CORE_PATH = ""
WEIGHTS_PATH = "weights/checkpoints/levit2019_balanced/"
...
if __name__ == "__main__":
    ...
    data_csv = pd.read_csv(TEST_LABELS_PATH)
    ...
    test_loss, test_w_f1, test_sens, test_spec, test_acc = evaluate_model('levit256_20_20240208-1436.pth')
    print(f" \
            Test loss: {test_loss}\n \
            Test F1: {test_w_f1}\n \
